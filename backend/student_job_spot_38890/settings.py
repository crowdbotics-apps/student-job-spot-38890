"""
Django settings for student_job_spot_38890 project.
...
ROOT_URLCONF = 'student_job_spot_38890.urls'
...
WSGI_APPLICATION = 'student_job_spot_38890.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "student_job_spot_38890 API",
    "DESCRIPTION": "API documentation for student_job_spot_38890 App",
    "VERSION": "v1",
}
